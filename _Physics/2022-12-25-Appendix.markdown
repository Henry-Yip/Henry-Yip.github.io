...
$[4][5]$ The Maclaurin series of a $f$ is its Taylor series about $x_0=0 . A Laurent series is a generalization of the Taylor series, allowing negative exponent values; it takes the form $\sum_{k=-\infty}^{\infty} c_k(z-a)^k$ and converges in an annulus."
