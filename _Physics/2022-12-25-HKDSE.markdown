...
From [Appendix A]({% link _Physics/2022-12-25-Appendix.markdown %}), we deduced that
$$r^2 \dot{\theta} \equiv h=\frac{|\underline{L}|}{m}$$, or equivalently $$|\underline{L}|=mr^2 \dot{\theta}$$. Combining the fact that $$r\dot{\theta}=v$$ we have $$|\underline{L}|=mrv$$
